                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-end gap-2 align-items-center">
                                ...
                                <?php else: ?>
                                    <button class="btn btn-sm btn-light text-primary" title="Direct Message"><i class="bi bi-chat-dots"></i></button>
                                    <button class="btn btn-sm btn-light text-secondary" title="View Profile" data-bs-toggle="modal" data-bs-target="#traineeModal<?= $index ?>"><i class="bi bi-person-lines-fill"></i></button>
                                <?php endif; ?>
                            </div>
                        </td>
                    </tr>

                    <!-- Trainee Profile Modal Mock -->
                            ...
                            <div class="modal-content border-0 shadow">
                                ...
                                <div class="modal-body text-center pt-0">
                                    ...
                                    <div class="d-flex justify-content-center gap-2 mb-4">
                                        <button class="btn btn-primary btn-sm"><i class="bi bi-chat-dots"></i> Message</button>
                                        <button class="btn btn-outline-secondary btn-sm">Full Report</button>
                                    </div>
